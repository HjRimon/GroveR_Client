...
//         <div>
//           <div>
//             <h1 className="md:text-4xl text-xl font-bold text-center my-20">Agreement Request</h1>
//             <div>
...
//                           style={{
//                             color: itemStatus[item._id]?.accepted === true ? "green" : "inherit",
//                           }}
//                           disabled={itemStatus[item._id]?.accepted}
//                         >
//                           <TiTickOutline /> {itemStatus[item._id]?.accepted ? "Accepted" : "Accept"}
//                         </button>
//                       </td>
//                       <td>
//                         <button
...
//                           className="btn btn-gost btn-xl"
//                           style={{
//                             color: itemStatus[item._id]?.rejected === true ? "red" : "inherit",
//                           }}
                      ...
                      <td>
                        {item.role === "admin" ? (
                          ...
                          <button
                            ...
                            className="btn btn-gost btn-xl"
                            style={{
                              color: itemStatus[item._id]?.accepted === true ? "green" : "black", // Update this line
                            }}
                            disabled={itemStatus[item._id]?.accepted}
                          >
                            <TiTickOutline />{" "}
                      ...
                      <td>
                        {item.role === "admin" ? (
                          ...
                          <button
                            ...
                            className="btn btn-gost btn-xl"
                            style={{
                              color: itemStatus[item._id]?.rejected === true ? "red" : "black", // Update this line
                            }}
                            disabled={itemStatus[item._id]?.rejected}
                          >
                            <ImCross /> {itemStatus[item._id]?.rejected ? "Rejected" : "Reject"}
