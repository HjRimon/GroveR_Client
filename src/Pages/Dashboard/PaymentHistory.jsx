...
//   const [filteredUsers] = usePayment();
//   return (
//     <div className="w-[100%] h-[100vh] mx-auto bg-gradient-to-b from-gray-900 via-purple-900 to-violet-600 text-white flex justify-center items-center gap-10">
...
//               <p className="subtitle">Pay : {item.discountedRent} $</p>
...
const PaymentHistory = () => {
  ...
  // Filtering payments based on the search term
